...
class JiWei:
    ...
    @classmethod
    def jwt_07(cls, u,video_camera_name):  #微信号登陆
        u.app_start('com.yoosee')
        sleep(8)
        if u(text='登录').exists:
            u(resourceId='com.yoosee:id/iv_wechat').click(timeout=5)
            # u(resourceId='com.yoosee:id/tv_newuser').click(timeout=5)
            sleep(3)
            assert u(resourceId='com.yoosee:id/layout_title').exists, '不在设备首页'
        else:
            # 退出登录
            u(resourceId='com.yoosee:id/icon_setting_img').click(timeout=5)
            sleep(1)
    ...
    @classmethod
    def jwt_08(cls, u, video_camera_name):  # 微信号登陆
        u.app_start('com.yoosee')
        sleep(8)
        if u(text='登录').exists:
            u(resourceId='com.yoosee:id/iv_wechat').click(timeout=5)
    ...
    @classmethod
    def jwt_09(cls, u,video_camera_name):  # 正确手机号登录
        u.app_start('com.yoosee')
        sleep(8)
        #登录
        ...
        while True:
            ...
            if u(text='发现新固件').exists:
                u(resourceId='com.yoosee:id/tv_upgrade_now').click(timeout=5)
                u(resourceId='com.yoosee:id/tv_background').click(timeout=5)
            elif u(text='检测到新版本').exists:
            ...
            elif u(resourceId='com.android.permissioncontroller:id/permission_message').exists:
                    u(resourceId='com.android.permissioncontroller:id/permission_allow_button1').click(timeout=5)
    ...
    #     if not u(text="有线连接自动化测试",resourceId="com.yoosee:id/tv_name").exists and not u(text=devices_name,resourceId="com.yoosee:id/tv_name").exists:
    ...
    #             if u(text=devices_name).exists:
    #                 u(text=devices_name).click(timeout=5)
    #                 break
    #             try:
    ...
    #         # sleep(2)
    #         # if u(text='请输入摄像机密码').exists:
    #         #     u(resourceId='com.yoosee:id/et_pwd').set_text("123")
    #         #     u(text='下一步').click(timeout=5)
    #         #     sleep(2)
